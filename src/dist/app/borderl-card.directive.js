...
var BorderCardDirective = /** @class */ (function () {
    function BorderCardDirective(el) {
        this.el = el;
        this.setBorder('#f5f5f5'); //couleur grise
        this.setHeight(180); //hauteur définie
    }
    //Gestion d'entrée de souris
    BorderCardDirective.prototype.onMouseEnter = function () {
        this.setBorder("#009688"); //Couleur verte 
    };
...
//# sourceMappingURL=borderl-card.directive.js.map